...
var fbwrap={debug:!0,isLoggedIn:!1,userID:null,user:null,pages:null,__pages:{next:null,prev:null,more:!0},photos_limit:25,initialize:function(){FB.init({appId:"370557326444175",xfbml:!0,version:"v2.5"})},isConnected:function(e){FB.getLoginStatus(function(e){return"connected"===e.status?(fbwrap.log(e,"info"),fbwrap.log("Logged in"),fbwrap.isLoggedIn=!0,!0):(fbwrap.log(e,"error"),fbwrap.log("Not logged in"),fbwrap.isLoggedIn=!1,!1)})},login:function(e){FB.login(function(t){"connected"===t.status?(fbwrap.log(t,"info"),fbwrap.log("Logged in successfully"),fbwrap.userID=t.authResponse.userID,fbwrap.isLoggedIn=!0):fbwrap.log(t,"error"),e&&e()},{scope:"manage_pages, public_profile"})},logout:function(e){fbwrap.log("Logged out"),fbwrap.isLoggedIn=!1,FB.logout(),e&&e()},getUser:function(e){return FB.api("me?fields=picture,name","GET",function(t){fbwrap.log(t,"info"),fbwrap.user=new fbwrap.User(t),e&&e()})},getPages:function(e,t){var o="me/accounts?fields=likes,name,talking_about_count,picture,photos,albums,access_token&limit=25"
...
break
case"debug":default:fbwrap.debug&&console.log(e)}},Page:function(e){this.id=e.id,this.name=e.name,this.thumb=e.picture.data.url,this.albums=[]
